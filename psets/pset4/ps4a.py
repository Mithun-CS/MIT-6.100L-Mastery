...
def is_heap(tree, compare_func):
    ...
    if tree is None:
        ...
        left_node = compare_func(tree.left.value,tree.value) if tree.left else True
        right_node = compare_func(tree.right.value,tree.value) if tree.right else True
        if left_node and right_node and is_heap(tree.left,compare_func) and is_heap(tree.right,compare_func):
            return True
        else:
            return False
