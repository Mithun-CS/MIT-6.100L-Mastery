...
class Message(object):
    ...
    def shift_char(self, char, shift):
        ...
        Shift_res =((ord(char)-32 + shift)%95) + 32
    ...
    def apply_pad(self, pad):
        ...
        '''
        letter = self.input_text
        empty_str=""
        for i in range(len(pad)):
            empty_str  += (self.shift_char(letter[i],pad[i]))
        return empty_str
...
class PlaintextMessage(Message):
    ...
    def generate_pad(self):
        ...
        '''
        pad_lst =[]
        given_letters = self.get_text()
        for i in range(len(given_letters)):
            pad_lst.append(random.randrange(0,110))
        return pad_lst
